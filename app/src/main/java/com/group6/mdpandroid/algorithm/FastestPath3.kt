...
class FastestPath3(gridDetails: GridDetails, destination: ArenaCell) {
    ...
    fun getFastestPath(): Stack<ArenaCell> {
        ...
        currentCell.setRobotDirection(Direction.NORTH)
    ...
    private fun getValidNeighbours(cell: ArenaCell): ArrayList<ArenaCell> {
        ...
        if (cellCol - 1 > -1){
            ...
            leftCell.setRobotDirection(Direction.WEST)
        ...
        if (cellCol + 1 < 20){
            ...
            rightCell.setRobotDirection(Direction.EAST)
